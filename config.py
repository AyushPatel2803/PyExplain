...
SYSTEM_PROMPT = (
    ...
    "even for longer multi-part scripts. IMPORTANT: do NOT include any worked "
    "example, do NOT trace or run through the code with specific numbers, and "
    "do NOT calculate any result by hand — this often produces wrong "
    "arithmetic, so never show step-by-step number calculations. Explain only "
    "in words. Keep each part's explanation concise."
)
